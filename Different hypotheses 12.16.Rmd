...
```{r}
p1 = c(0.30, 0.36, 0.40, 0.40) # unsafe nTTP (null hypothesis)
p2 = c(0.05, 0.17, 0.15, 0.10) # acceptable nTTP (alternative hypothesis)
...
pDLT = c(0.008, 0.011, 0.064, 0.195, 0.330, 0.446)
...
* H0: p = 0.36 vs. H1: p = 0.17 (approximated from above weight matrix)
...
Group 2: 0.36 vs 0.17 (calculated from Ezzalfani weight matrix)
...
rbind(
  ...
  knitr::kable(row.names = TRUE, 
               ...
               format = "html") %>%
  kableExtra::kable_styling("striped", full_width = F) %>%
  kableExtra::pack_rows("Scenario 1", 3, 7) %>%
  kableExtra::pack_rows("Scenario 2", 8, 12) %>%
  kableExtra::pack_rows("Scenario 3", 13, 17) %>%
  kableExtra::pack_rows("Scenario 4", 18, 22) %>%
  kableExtra::pack_rows("Scenario 5", 23, 27)
